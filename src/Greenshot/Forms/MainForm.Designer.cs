...
namespace Greenshot.Forms {
	partial class MainForm {
		...
		private void InitializeComponent() {
            ...
            this.contextmenu_macroeditor = new GreenshotToolStripMenuItem();
			...
			// 
			// contextmenu_macroeditor
			// 
			this.contextmenu_macroeditor.Name = "contextmenu_macroeditor";
			this.contextmenu_macroeditor.Size = new System.Drawing.Size(170, 22);
			this.contextmenu_macroeditor.Text = "Macro Editor";
			this.contextmenu_macroeditor.Click += new System.EventHandler(this.Contextmenu_MacroEditorClick);
			// 
		...
		private GreenshotToolStripMenuItem contextmenu_macroeditor;
